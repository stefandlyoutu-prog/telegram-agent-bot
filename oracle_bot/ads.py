...
def pain_awareness_channel_v2(source: str = "") -> str:
    ...
    return (
        ...
        "Те же мысли, те же сомнения — и ощущение, что топчешься на месте. 🌀\n\n"
        "Загляни на 2 месяца вперёд по своей дате рождения:\n"
        "🔴 <b>что будет, если оставить всё как есть</b>\n"
        "🟢 <b>и что изменится, если начать действовать осознанно</b>\n\n"
        "Не гороскоп «для всех» — 4 вопроса про <b>твою</b> ситуацию и ответ лично тебе.\n"
        "Первый разбор — <b>бесплатно</b>.\n\n"
        f'👉 <a href="{link}">Узнать свои 2 сценария</a>'
    )
