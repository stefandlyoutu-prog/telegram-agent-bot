...
export const TECHNOLOGIES = [
  ...
  },
  {
    ...
    desc: "Ручная шлифовка абразивными губками. Удаляется только явно отслаивающееся старое покрытие. Не предполагает полного удаления. На новых домах — убирается поднятый ворс.",
    guarantee: 1,
  },
  {
    id: 3,
    ...
    desc: "Эксцентриковая шлифмашина. Удаляется только явно отслаивающееся и слабодержащееся покрытие. Не полное удаление. На новых домах — снимается верхний слой, лучше впитываемость.",
    guarantee: 3,
  },
  {
    id: 4,
    ...
    desc: "Базовая подготовка. УШМ и эксцентрик. Полностью удаляется старое покрытие до древесины. Гарантия — по составу ЛКМ.",
    isBase: true,
    guarantee: "lkm",
  },
  {
    id: 5,
    short: "2 прохода (окр.)",
    title: "5. Шлифовка в 2 прохода (ранее окрашенный дом)",
    desc: "УШМ и эксцентрик. Полностью до древесины. Для ранее окрашенных домов. Гарантия — по составу ЛКМ.",
    guarantee: "lkm",
  },
];
