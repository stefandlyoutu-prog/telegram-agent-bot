...
ORACLE_BRIEF = """
Telegram-бот @MOracul_bot — личный оракул и таро в кармане:
...
- в озвучке бот называй: «бот Оракул в Телеграме»
...
ORACLE_TOPICS: list[str] = [
    ...
    # Виральные форматы (референсы TikTok с сотнями тысяч просмотров)
    "Знаки зодиака с душой ангела",
    "Знаки зодиака, которых нельзя обманывать",
    "Знаки зодиака, которых ждут большие деньги",
    "Знаки зодиака с самой сильной интуицией",
    "Притча о двух волках, которые живут в каждом из нас",
    "Притча: старец, ученик и вопрос о судьбе",
    "Притча о закрытой двери, которую все толкали",
    "Загадай вопрос и останови видео — вот твой ответ",
    "Выбери карту: один, два или три",
    "Останови видео и узнай, что ждёт тебя на этой неделе",
]
